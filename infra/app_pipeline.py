...
class AppPipelineStack(core.Construct):
    ...
    def __init__(self, scope: core.Construct, id: str, props: dict, crs: CommonResourceStack) -> None:
        ...
        github_bline_app_arn = props.get("GITHUB_BLINE_APP_ARN")
        github_lldc_app_arn = props.get("GITHUB_LLDC_APP_ARN")
        ...
        secrets_policy=iam.PolicyStatement(
            resources=[github_bline_app_arn, github_lldc_app_arn],
        ...
        build_action = actions.CodeBuildAction(
            ...
            environment_variables={
                ...
                "GITHUB_BLINE_APP_ARN": codebuild.BuildEnvironmentVariable(value=github_bline_app_arn),
                "GITHUB_LLDC_APP_ARN": codebuild.BuildEnvironmentVariable(value=github_lldc_app_arn),
